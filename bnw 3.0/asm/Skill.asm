...
animal_dance_text:
a_wind:		db	"Cock",$07,"rice:Non-e",$E1,"ment",$E2,$EB,"mg|Igno",$F1,$E0,"def.,",$F7,$E5,$E0,"[P",$E5,"r",$F5,"y]",$00
a_forest:	db	"Raccoon:Cu",$F1,$E0,"HP to max|L",$F5,"t",$E0,"most ba",$F4,"st",$07,"use",$E0,"- party",$00
a_desert:	db	"Meerk",$07,":|S",$E5,$E0,"[Image]/[Haste]",$0E," party",$00
a_love:		db	"Tapir:Cu",$F1,$E0,"MP|L",$F5,"t",$E0,$E2,"l ba",$F4,"st",$07,"use",$E0,"- party",$00
a_earth:	db	"Jackrabbit:Non-e",$E1,"ment",$E2,$EB,"mg|Igno",$F1,$E0,"def., groun",$F4,$07,$F0,"ck",$00
a_water:	db	"Toxic Frog:",$FD,"/",$EF,",",$F7,$E5,$E0,"[Poison]",$00
a_dusk:		db	"Womb",$07,":Non-e",$E1,"ment",$E2,$EB,"mg|Igno",$F1,$E0,"def., groun",$F4,$07,$F0,"ck",$03,"- ",$E2,"l foes",$00
a_snowman:	db	"Snowbird:Cu",$F1,$E0,"HP to max|S",$E5,$E0,"[Image]",$0E," party",$00
