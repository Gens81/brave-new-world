...
;Phoenix Tear reward for betting Magus Rod (Drifter enemy)
org $DFB6D0
	db $A9,$40,$F9

;150 bpow Megaflare (Bahamut)
org $C46E70
	db $96
...
;zoning edits to avoid missables entries in the Diary
org $CF553F
	db $B8	;pack 184 (Mudcrab in Triangle Island) 
org $CF55EF
	db $EC	;pack 236 (Succubus, Madam, Suriander, Eukaryote e Pan Dora in WoR overworld in place of FC rages)
org $CF55F3
	db $F0	;pack 240 (Samurai, Parasoul, Suriander, Madam, Succubus in WoR overworld in place of FC rages)
org $CF5625
	db $F3	;pack 243 (Ganymede, Europa, IO in Moogle Cave)

;removed rare Potion drop from Lv.2,4,6,8 Mage
org $CF34E6
	db $FF

; Aqua Slash (Spell #160d)
; 	MP cost = 0, Spell Power = 12, Hit Rate = 101
; 	Can move cursor, One Side Only, Enemy Default
; 	Auto-retarget, water-elemental spell

org $C47380 : db	$43, $80, $00, $20, $00, $00, $0C, $00, $65

;printme/rom discrepancies fixes
org $CF0054	: db $C2		;2    Phalanx     Immunity  Amulet + Ribbon     
org $CF0156	: db $00        ;10   Parasoul    Immunity  Amulet
org $CF01B6	: db $10        ;13   Wrexsoul    Immunity  Undead/All + HP% 
org $CF0714	: db $00,$00    ;56   Nautiloid   Immunity  -
org $CF07FD	: db $08        ;63   Thanatos    Innate    Haste 
org $CF0895	: db $B9        ;68   Telstar     Immunity  Machine (All but Blind)
org $CF0974	: db $E7        ;75   Cave Stuff  Immunity  Plant (All but Sleep)
org $CF0CD5	: db $B1        ;102  Templar     Immunity  Amulet + Ribbon
org $CF0FB4	: db $02        ;125  Wart Puck   Immunity  Amulet 
org $CF12D4	: db $00        ;150  Cephalid    Immunity  -
org $CF139D	: db $08        ;156  Reaper      Innate    Haste
org $CF1415	: db $B9        ;160  Chaser      Immunity  Machine (All but Blind)
org $CF14D4	: db $E7        ;166  Pond Scum   Immunity  Plant (All but Sleep)
org $CF17E8	: db $60,$09    ;191  Umbro       HP        2400
org $CF1AFD	: db $08        ;215  Death       Innate    Haste
org $CF1B7D	: db $02        ;219  Tofu        Innate    Regen
org $CF1C16	: db $10        ;224  Diablos     Immunity  Amulet + Ribbon
org $CF1ED5	: db $B9        ;246  Searcher    Immunity  Machine (All but Blind)
org $CF2408	: db $A9,$61    ;288  Larry       HP        25000
org $CF2428	: db $31,$75    ;289  Moe         HP        30000
org $CF2739	: db $08        ;313  Lv.8 Mage   Weakness  Dark
org $CF2ADD	: db $01        ;342  Phantom     Innate    Float

; stop displaying required XP for next LV up in status menu once LV 50 is reached
org $C360A6 : CMP #$32

org $C3F491
	db $1E		;esper name position in review screen (15 tiles after the char name)

;item and equip menu stamina>spirit
org $C38D83 : db "Spirit " ; item menu
org $C3A37B : db "Spirit " ; equip menu
...
; Changes Phoenix Summon to behave like Kirin Summon,
; but with 80 MP cost, 255 spell power, and also secretly dispels freeze.
; This change should stop phoenix from "missing" which should fix the
; Setzer BAR BAR BAR bug, and limit/prevent graphical glitches
;org $C46F20
;    db $2E,$00,$68,$02,$65,$50,$FF,$00,$00,$4E,$80,$00,$00,$02
	
; This change treats spells in the "Dance" range in the spell index as Lores, instead of Magic
; This lets Gau and Gogo properly display the blue magic pre-animation when they cast one of these spells via Rage
org $C21DE7
    db $0C

;fixed preanimation not playing for ground attack targeting flying enemies
;org $C2FC64         ; Untarget Floating targets, except if all targets are Floating
;  LDA #$01
;  TSB $B0           ; Restore preanimation flag
;                    ;  (was clobbered on first pass through C2/57C2)
;  JMP $57C2         ; Set up animation data

!freeZombie = $C2AEF6
;disrespectful zombie adapted code 
org $C2458C
  JSR ZombieHelper   ;deal with Zombie subtractions

org !freeZombie
ZombieHelper:
  LDA $331C,Y        ;Blocked statuses, bytes 1 and 2.  Blocked bits are 0
  EOR #$FFFF
  ORA #$4DFA         ;Only allow a status if the target's immune to it, or if it's not one of the following:  Blind, Poison, Kneeling, Berserk, Muddle, Sleep
...
; Changes Beginner's Classroom Bouncer NPC and palette to be noticable to FF6 vets
org $C421F8 : db $92
org $C421FC : db $2E
