...
statusslash:        dw $7B1B	: db "/",$00        
statusslash2:       dw $7B5B	: db "/",$00        
statusLV:           dw $7999	: db "LV",$00       
statusHP:           dw $7B0D	: db "HP",$00       
statusPM:           dw $7B4D	: db "MP",$00       
statusnextlv:       dw $79A7	: db "Next",$00
statusvigor:        dw $3C4D	: db "Vigor",$00    
statusmagic:        dw $3CCD	: db "Magic",$00    
statusspeed:        dw $3D4D	: db "Speed",$00    
statusstamina:      dw $3DCD	: db "Spirit",$00  
statusattack:       dw $3E4D	: db "Attack",$00   
statusdefense:      dw $3ECD	: db "Defense",$00  
statusmagicdefense: dw $3FCD	: db "M.Defense",$00
statusevade:        dw $3F4D	: db "Evade",$00
...
Half:       dw $7DAF		: db "Half Damage",$00
No_Dmg:     dw $7C2F		: db "Absorb",$00
Absorb:     dw $7CEF		: db "No Damage",$00
Weak:       dw $7E6F		: db "Weakness",$00
Auto:       dw $7C2F		: db "Auto  ",$00
Blocks:     dw $7E2F		: db "Blocks",$00
Bonus:      dw $7D2F		: db "Bonus",$00
blind:      dw $7E2F+64		: db $5d,$5e,$5f,$00
poison:     dw $7E2F+64+8	: db $49,$4a,$4b,$00
mute:       dw $7E2F+64+16	: db $30,$27,$33,$00
muddle:     dw $7E2F+128	: db $30,$31,$32,$33,$00
berserk:    dw $7E2F+128+8	: db $34,$35,$36,$37,$00
sleep:      dw $7E2F+128+16	: db $2a,$2b,$29,$00
stop:       dw $7E2F+192	: db $40,$41,$00
petrify:    dw $7E2F+192+8	: db $2c,$2d,$2e,$2f,$00
death:      dw $7E2F+192+16	: db $46,$38,$48,$00
imp:        dw $7E2F+256	: db $56,$29,$00
slow:       dw $7E2F+256+8	: db $2A,$4c,$4D,$00
sap:        dw $7E2F+256+16	: db $28,$29,$00
safe:       dw $7C2F+64		: db $28,$45,$00
haste:      dw $7C2F+64+6	: db $42,$43,$44,$00
regen:      dw $7C2F+64+14	: db $20,$21,$22,$00
shell:      dw $7C2F+128	: db $53,$54,$55,$00
brsrk_auto: dw $7C2F+128+6	: db $34,$35,$36,$37,$00
reflect:    dw $7C2F+128+14	: db $20,$25,$26,$52,$00
atk:        dw $7D2F+64		: db $38,$39,$3A,$00
HP_label:   dw $7D2F+64+6	: db $4E,$4F,$00
plus_HP_1:  dw $7D2F+64+6	: db $4E,$4F,$CA,$00   
plus_HP_2:  dw $7D2F+64+6	: db $4E,$4F,$CA,$D1,$00
counter:    dw $7D2F+64+14	: db $57,$3E,$3F,$59,$00
mag:        dw $7D2F+128	: db $3B,$3C,$3D,$00
MP_label:   dw $7D2F+128+6	: db $47,$4F,$00
plus_MP_1:  dw $7D2F+128+6	: db $47,$4F,$CA,$00
plus_MP_2:  dw $7D2F+128+6	: db $47,$4F,$CA,$D1,$00
cover:      dw $7D2F+128+14	: db $57,$58,$59,$00
...
org $C9fcf0
change_palette:
    cmp #$EC          		; Cmp if icon - Value over Ranged icon
