...
table "menu.tbl",ltr
;bigrams, elements and skills icons legenda
;at     $07
;g 	    $08
; - 	$0E
;s 	    $E0
...
HealingShiv:    db "[Fight] cure",$E0,"HP",$00
...
AtmaWeapon:     db "Attack",$E0,"w/ spirit|Weaker at low HP",$00
...
Kazekiri:       db "May hit all foe",$E0,"with|a spirit-based wind attack",$00
Murasame:       db "May counterattack",$00
Masamune:       db "May counterattack",$00
Spoon:          db "",$00
Mutsunokami:    db "May hit all foe",$E0,"with|a spirit-based wind attack",$00
SpookStick:     db "",$00
...
WindBreaker:    db "May hit all foe",$E0,"with|a spirit-based wind attack",$00
...
BoneClub:       db "",$00
MagicBone:      db "",$00
WingEdge:       db "Anti-air, high crit rate|Ignore",$E0,"row, dual-wield",$00
Cards:          db "",$00
...
Chainsaw:       db "Ignore",$E0,"defense|Randomly kills",$00
Defibrillator:  db "Revive",$E0,"fallen ally",$00
Drill:          db "Ignore",$E0,"defense|Set",$E0,"[Sap]",$00
ManaBattery:    db "Cure",$E0,"MP - one ally",$00
...
InvizScroll:    db "Set",$E0,"[Clear]",$00
...
Beads:          db "",$00
ExBlack:        db "",$00
HeijiCoin:      db "[Slot] to [GP Toss]|Tossed GP scales w/ spirit",$00
...
SnakeOil:       db "Cure",$E0,"1/4 max HP|Lift",$E0,"ALL bad statuses",$00
...
BouncyBall:     db "Random dmg to foes",$00
RedBull:        db "Cure",$E0,"200 HP|Set",$E0,"[Float]",$00
SlimJim:        db "Cure",$E0,"100 HP|Set",$E0,"[Regen]/[Haste]",$00
WarpWhistle:    db "Cast",$E0,$EA,"Warp",$00
...
LeoSpirits:
    db "A bottle of Leo'",$E0,"favorite spirit",$00
Blank3: db $00
Pendant:
...
Ice: db $FB,$00
Bolt: db $F8,$00
Sap: db $EF," S",$E5,$E0,$F3,"ap]|Periodic",$EB,"mg, l",$F5,"t",$E0,"[Regen]",$00 ; Dark Sets "Sap", periodic dmg, lifts "Regen"
Poison: db $EF," S",$E5,$E0,"[Poison]|Ris",$E4,$08,"periodic",$EB,"mg",$00 ; Dark Sets "Poison"|Rising periodic dmg
Fire2: db $FC,$FC,$00
Ice2: db $FB,$FB,$00
Bolt2: db $F8,$F8,$00
...
Doom: db "May inflict ins",$F0,"nt",$EB,"e",$07,"h|He",$E2,$E0,"undeads",$00; May give instant death|Heals undeads
...
XZone: db "May inflict ins",$F0,"nt",$EB,"e",$07,"h",$00 ; May give instant death
Meteor: db "Non-e",$E1,"ment",$E2,$EB,"mg",$00 ; Non-elemental dmg
Ultima: db "Ultim",$07,$E7,"magic ",$07,$F0,"ck",$00 ; Ultimate Magic Attack
Merton: db $FC,"/",$EF,$00 ; Fire/Dark
Demi: db $FA," May inflict fractional",$EB,"mg (HP * ",$11,")",$00 ; Earth, May inflict fractional dmg (HP * 1/2)
Quartr: db $FA," May inflict fractional",$EB,"mg (HP * ",$12,")",$00 ; Earth, May inflict fractional dmg (HP * 3/4)
Drain: db "Ste",$E2,$E0,"HP|Hitr",$07,$E7,"= 90%",$00 ; Steals HP
Osmose: db "Ste",$E2,$E0,"MP|Hitr",$07,$E7,"= 90%",$00 ; Steals MP
Rasp: db "May inflict MP",$EB,"mg",$00 ; May inflict MP dmg
Muddle: db "May s",$E5," [Mudd",$E1,"]|At",$F0,"ck random ",$E2,"lie",$E0,"unt",$EC," phys. hit",$00 ; May set "Muddle"|Attack random allies until phys. hit
Mute: db "May s",$E5," [Mute]|Can't",$EB,"o anyth",$E4,$08,"th",$07," cost",$E0,"MP",$00; May set "Mute"|Can't do anything that costs MP
Sleep: db "May s",$E5," ",$F3,$E1,"ep]|Inactiv",$E7,"unt",$EC,$03,"phys.",$03,"hit",$03,"or",$03,"it wear",$E0,"off",$00 ; May set "Sleep"|Inactive until phys. hit or it wears off
SleepX: db "May s",$E5," ",$F3,$E1,"ep]",$00 ; May set "Sleep"
Imp: db "S",$E5,"s/l",$F5,"t",$E0,"[Imp]|Dm",$08,"an",$F4,"he",$E2,$E4,$08,"output h",$E2,"ved",$00 ; Sets/lifts "Imp"|Dmg and healing output halved
Bserk: db "S",$E5,$E0,"[Berserk]|Phys.",$EB,"m",$08,"up, uncontrollab",$E1,$00 ; Sets "Berserk"|Physical dmg up, uncontrollable
Stop: db "May s",$E5," ",$F3,"top]|Can't mov",$E7,"for a brief time",$00 ; May set "Stop"|Can't move for a brief time
Safe: db "S",$E5,$E0,$F3,"afe]|Reduc",$E7,"physic",$E2,$EB,"m",$08,$F0,"ken",$00 ; Sets "Safe"|Reduce physical dmg taken
Shell: db "S",$E5,$E0,$F3,"hell]|Reduc",$E7,"magic",$E2,$EB,"m",$08,$F0,"ken",$00 ; Sets "Shell"|Reduce magical dmg taken
...
Slow: db "May s",$E5," ",$F3,"low]|Speed",$EB,"own, l",$F5,"t",$E0,"[Haste]",$00 ; Sets "Slow"|Speed down, lifts "Haste"
SlowX: db "May s",$E5," ",$F3,"low]",$00 ; May set "Slow"
...
Warp: db "Run from",$EB,"ungeon or b",$07,"tle",$00
Scan: db "Give",$E0,"weaknes",$E0,"an",$F4,"behavior h",$E4,"ts|(P",$F1,"s",$E0,$D8,"/",$D9," on ",$F0,"rg",$E5," for other ",$E4,"fo)",$00 ; Gives weakness and behavior hints|Press X/Y on target for other info
Dispel: db "L",$F5,"t",$E0,"positiv",$E7,"s",$F0,"tuses",$00 ; Lifts positive statuses
Cure: db "Cu",$F1,$E0,"HP|",$F6,$EB,"m",$08,"to undead",$00; Cures HP|Holy dmg to undead
Cure2: db "Cu",$F1,$E0,"HP|",$F6,$F6,$00
Cure3: db "Cu",$F1,$E0,"HP|",$F6,$F6,$F6,$00
Life: db "Revive",$E0,"f",$E2,$E1,"n ",$E2,"ly|(HP = 250~500)",$00 ; Revives fallen ally|(HP = 250~500)
Life2: db "Revive",$E0,"f",$E2,$E1,"n ",$E2,"ly|(HP = max)",$00 ; Revives fallen ally|HP = max
Rerise: db "S",$E5,$E0,"[Rerise]|Cast",$E0,$E8,"L",$F5,$E7,"upon",$EB,"e",$07,"h",$00; Sets "Rerise"|Casts Life upon death
GRemedy: db "Cu",$F1,$E0,"HP (spirit-based)|L",$F5,"t",$E0,"most ba",$F4,"s",$F0,"tuses",$00 ; Cures HP (spirit-based)|Lifts most bad statuses
Regen: db "S",$E5,$E0,"[Regen]; periodic he",$E2,", l",$F5,"t",$E0,"[Sap]|Cu",$F1,$E0,"HP (spirit-based)",$00 ; Sets "Regen" (periodic heal; lifts Sap)|Cures HP (spirit-based)
RegenX: db "S",$E5,$E0,"[Regen]|Cu",$F1,$E0,"HP (spirit-based)",$00 ; Sets "Regen"|Cures HP (spirit-based)
...
Aurabolt:
	db $F6," (spirit-based)|Row affect",$E0,"dmg",$00
FireDance:
	db $FC,$00
Mantra:
	db "Cure",$E0,"HP (spirit-based)|Weaker at low HP",$00
Chakra:
	db "Cure",$E0,"MP (spirit-based)",$00
SonicBoom:
	db $F9," (spirit-based)",$00
BumRush:
	db "Ultimate Blitz technique",$00
...
Dispatch:
	db "Phys. attack (ignore",$E0,"def.)|2x",$EB,"mg to humans",$00
Mindblow:
	db "500 MP",$EB,"mg",$00
Empowerer:
...
Dragon:
	db "Ignore",$E0,"def. (spirit-based",$EB,"mg)|May",$F7,$E5," [Petrify]",$00
Eclipse:
...
Aqualung:
	db $FD,$00
BadBreath:
	db "May set [Poison]/[Blind]/[Mute]",$00
BlackOmen:
...
Discord:
	db "May set [Muddle]/[Berserk]|Unreflectable",$00
HolyWind:
	db "Cure",$E0,"HP|Amount healed = caster'",$E0,"(current) HP",$00
Raid:
	db "May steal HP/MP|Ignore",$E0,"def., unreflectable",$00
Raze:
...
Unicorn: db "Heal Horn:Cure",$E0,"HP (spirit-based)|Lift",$E0,"most bad statuses",$00
...
VgrSta: db "+1 Vigor/+1 Spirit per EL spent",$00
MagSta: db "+1 Magic/+1 Spirit per EL spent",$00
SpdSta: db "+1 Speed/+1 Spirit per EL spent",$00
HPSta: db "+30 HP/+1 Spirit per EL spent",$00
MPSta: db "+25 MP/+1 Spirit per EL spent",$00
Vigor: db "+2 Vigor per EL spent",$00
Speed: db "+2 Speed per EL spent",$00
Stamina: db "+2 Spirit per EL spent",$00
