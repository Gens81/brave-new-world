...
org $CFD0D0
	...
	db "Syphon    " ;052  Tumbleweed *
	db "Evil>Dead " ;053   Plantpire
	db "Barb      " ;054   Trilobite
	db "Zulfiqar  " ;055   Siegfried *
	db "Ink>Cloud " ;056   Nautiloid *
	...
	db "Sludge    " ;075  Cave Stuff *
	db "Mind>Sting" ;076     Cactuar *
	db "          " ;077
	db "Hook      " ;078        Hobo
	db "Bang      " ;079        Bomb
	db "          " ;080
	db "Mystify   " ;081       Boxxy
	db "Waltz     " ;082  Slamdancer *
	db "Haymaker  " ;083       Giant *
	db "Stab      " ;084         Pug
	db "Slap      " ;085   Magic Pot
	db "          " ;086
	db "          " ;087
	db "Charge    " ;088    Buffalax
	db "Emulate   " ;089   Eukaryote *
	db "Subcon    " ;090       Wight
	db "Crusher   " ;091       Troll *
	...
	db "Mangle    " ;116  Black Bear *
	db "Ram       " ;117      Rhydon
	db "Gnaw      " ;118      Rabite
	db "Pounce    " ;119    Wild Cat *
	...
	db "Shred     " ;128      Raptor
	db "Swing     " ;129      Wyvern
	db "Femur     " ;130     Zombone *
	db "          " ;131
	db "Smack     " ;132  Brontosaur
	db "Punish    " ;133    Dinosaur *
	db "Gaze      " ;134  Cockatrice
	db "Wolfsbane " ;135  Windrunner *
	...
	db "Eye>Gouge " ;230      Osprey *
	db "Tired     " ;231  Hot Wheels
	db "Stinger   " ;232        Wasp
	db "Stinger   " ;233     Anemone *
	db "Rocket    " ;234     Arsenal
	db "Moonwort  " ;235       Racer *
	db "Grey>Talon" ;236         Roc
	db "Delete    " ;237     Android
	db "Virus     " ;238       Kudzu
	db "Spanner   " ;239      Junkie *
