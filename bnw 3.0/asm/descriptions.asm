...
WindBreaker:    db "Wind hit",$E0,"with much spirit",$00
...
Bserk: db "S",$E5,$E0,"[Berserk]|Phys.",$EB,"m",$08,"up, becom",$E7,"uncontrollab",$E1,$00 ; Sets "Berserk"|Phys. dmg up, become uncontrollable
...
Shoat: db "Hurricane:|May set [Petrify] (low hit%)",$00
